...
#define CONFIG_EXTRA_ENV_SETTINGS		\
	...
	"boot_fdt=try\0" \
	"fdt_file=fsl-imx8mq-p100ivm.dtb\0" \
	"initrd_addr=0x43800000\0"		\
	"initrd_high=0xffffffffffffffff\0" \
	...
	"mmcautodetect=yes\0" \
	"mmcargs=setenv bootargs ${jh_clk} console=${console} root=${mmcroot} ${mmcmisc}\0 " \
...
#if defined(CONFIG_TARGET_IMX8MQ_P100IVM)
/* two bank support */
